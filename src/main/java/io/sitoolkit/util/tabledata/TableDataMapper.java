...
import io.sitoolkit.util.tabledata.schema.LocalizedProperty;
import io.sitoolkit.util.tabledata.schema.Mapping;
import io.sitoolkit.util.tabledata.schema.Table;
